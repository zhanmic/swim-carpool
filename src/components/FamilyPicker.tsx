...
export function FamilyPicker({ families, familyColors, onSelect, title = "Select family as driver" }: FamilyPickerProps) {
  return (
    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center bg-black/40 p-4 safe-bottom">
      <div className="w-full max-w-md rounded-2xl bg-white p-6 shadow-xl dark:bg-slate-900">
        ...
        <p className="text-sm text-slate-500 mb-4 dark:text-slate-400">Saved on this device only.</p>
